...
4. Repeat steps 2 and 3 with your pair’s favorite foods.
5. Save the file.
...
7. Inside of `compare_favs.py` do the following:
  ...
  2. read all of your favorite foods into a list called `[your_name]_favs`
  3. close the file
  ...
  8. Call the compare_favs function with your favs and your pair’s favs
9. Run `compare_favs.py`! Make sure it works!
